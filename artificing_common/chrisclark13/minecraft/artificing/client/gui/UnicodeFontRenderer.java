...
/**
 * Because Unicode font is smaller and looks nicer for the guide books</br>
 * Copied whole class because apparently there's some Optifine issues.
 */
...
public class UnicodeFontRenderer extends FontRenderer {
    ...
    /**
     * Array of GL texture ids for loaded glyph_XX.png images. Indexed by
     * Unicode block (group of 256 chars).
     */
    ...
    public UnicodeFontRenderer(GameSettings gameSettings, String textImage,
            RenderEngine renderEngine, boolean unicode) {
    ...
    private float renderCharAtPos(int par1, char par2, boolean par3) {
        ...
        return par2 == 32 ? 4.0F : (par1 > 0 && !this.unicodeFlag ? this.renderDefaultChar(
                par1 + 32, par3) : this.renderUnicodeChar(par2, par3));
    }
        ...
        for (int var3 = 0; var3 < par1Str.length(); ++var3) {
            ...
            if (var4 == 167 && var3 + 1 < par1Str.length()) {
                ...
                if (var5 < 16) {
                    ...
                    this.textColor = var6;
                    GL11.glColor4f((float) (var6 >> 16) / 255.0F,
                            (float) (var6 >> 8 & 255) / 255.0F, (float) (var6 & 255) / 255.0F,
                            this.alpha);
                } else if (var5 == 16) {
                ...
                if (this.randomStyle && var5 > 0) {
                    do {
                        var6 = this.fontRandom.nextInt(ChatAllowedCharacters.allowedCharacters
                                .length());
                ...
                // if (guiScale % 2 == 1)
                /*
                 * if (true) { scaleDown = 2/3F; scaleUp = 1.5F; }
                 */
                ...
                if (this.boldStyle) {
                    this.posX += (unicodeFlag) ? 0.5 : 1;
                    this.renderCharAtPos(var5, var4, this.italicStyle);
                    this.posX -= (unicodeFlag) ? -0.5 : 1;
                    var9 += (unicodeFlag) ? 0.5 : 1;
                }
                ...
                if (this.strikethroughStyle) {
                    ...
                    var7.addVertex((double) this.posX,
                            (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
                    var7.addVertex((double) (this.posX + var9),
                            (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
                    var7.addVertex((double) (this.posX + var9), (double) (this.posY
                            + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
                    var7.addVertex((double) this.posX, (double) (this.posY
                            + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
                    var7.draw();
                ...
                if (this.underlineStyle) {
                    ...
                    var7.addVertex((double) (this.posX + (float) var8),
                            (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
                    var7.addVertex((double) (this.posX + var9),
                            (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
                    var7.addVertex((double) (this.posX + var9), (double) (this.posY
                            + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
                    var7.addVertex((double) (this.posX + (float) var8), (double) (this.posY
                            + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
                    var7.draw();
                    GL11.glEnable(GL11.GL_TEXTURE_2D);
                }
     ...
     */
    private int renderStringAligned(String par1Str, int par2, int par3, int par4, int par5,
            boolean par6) {
        if (this.bidiFlag) {
            par1Str = this.bidiReorder(par1Str);
    ...
    public void drawSplitString(String string, int posX, int posY, int length, int par5) {
        ...
        // posX -= 28;
        /*
         * posX *= 1.32; posX -= 35; posY *= 1.2; length *= 1.32;
         */
        // }
