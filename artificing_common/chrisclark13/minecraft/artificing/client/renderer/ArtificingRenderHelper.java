...
public class ArtificingRenderHelper {
     ...
     */
    public static void render3DItemStack(ItemStack itemStack)
    {
        GL11.glPushMatrix();
...
//            ForgeHooksClient.renderEquippedItem(ItemRenderType.EQUIPPED, customRenderer, renderBlocksInstance, mc.thePlayer, itemStack);
        ...
        else
        {
            ...
            render3DImage(tessellator, f1, f2, f, f3, icon.getSheetWidth(), icon.getSheetHeight(), 0.0625F);
     ...
     * 
     * Image is rendered with the bottom left of the item at 0,0,0 and the top right of it at 1.0, 1.0, 0 </br>
     * The thickness extends the image on the positive Z axis.
     */
    public static void render3DImage(Tessellator tessellator, float uMin, float vMin, float uMax, float vMax, int imageWidth, int imageHeight, float thickness)
    {
        //Draw Front
        ...
        for (k = 0; (float)k < pixelWidth; ++k)
        {
            ...
            tessellator.addVertexWithUV((double)xy, 0.0D, (double)(0.0F), (double)uv, (double)vMax);
            ...
            tessellator.addVertexWithUV((double)xy, 1.0D, (double)(0.0F), (double)uv, (double)vMin);
        }
        ...
        for (k = 0; (float)k < pixelWidth; ++k)
        {
            ...
            tessellator.addVertexWithUV((double)uv2, 1.0D, (double)(0.0F), (double)uv, (double)vMin);
            ...
            tessellator.addVertexWithUV((double)uv2, 0.0D, (double)(0.0F), (double)uv, (double)vMax);
        }
        ...
        for (k = 0; (float)k < pixelHeight; ++k)
        {
            ...
            tessellator.addVertexWithUV(1.0D, (double)uv2, (double)(0.0F), (double)uMax, (double)uv);
            tessellator.addVertexWithUV(0.0D, (double)uv2, (double)(0.0F), (double)uMin, (double)uv);
        }
        ...
        for (k = 0; (float)k < pixelHeight; ++k)
        {
            ...
            tessellator.addVertexWithUV(0.0D, (double)xy, (double)(0.0F), (double)uMin, (double)uv);
            tessellator.addVertexWithUV(1.0D, (double)xy, (double)(0.0F), (double)uMax, (double)uv);
        }
...
//            {
//                this.render3DItemStack(entityclientplayermp, itemstack, 0, ItemRenderType.EQUIPPED_FIRST_PERSON);
...
//                    this.render3DItemStack(entityclientplayermp, itemstack, x, ItemRenderType.EQUIPPED_FIRST_PERSON);
//                }
//            }
//            else
//            {
