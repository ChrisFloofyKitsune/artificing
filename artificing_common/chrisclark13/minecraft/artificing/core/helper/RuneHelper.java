...
public class RuneHelper {
    ...
    public static void initMultiSlotItems() {
        ...
        // All/Default
        MultiSlotItemRegistry.registerUnlocalizedName(ENCHANTMENT_DEFAULT + ".1", Textures.MSI_LOC
                + "runeAll1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName(ENCHANTMENT_DEFAULT + ".2", Textures.MSI_LOC
                + "runeAll2.png", " #\n" + "#X");
        MultiSlotItemRegistry.registerUnlocalizedName(ENCHANTMENT_DEFAULT + ".3", Textures.MSI_LOC
                + "runeAll3.png", "##\n" + "X#\n" + "# ");
        MultiSlotItemRegistry.registerUnlocalizedName(ENCHANTMENT_DEFAULT + ".4", Textures.MSI_LOC
                + "runeAll4.png", "#  #\n" + "##X#\n" + "#  #");
        MultiSlotItemRegistry.registerUnlocalizedName(ENCHANTMENT_DEFAULT + ".5", Textures.MSI_LOC
                + "runeAll5.png", "##  \n" + " ###\n" + " X##\n" + " ###\n" + "##  ");
        
        // Armor
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor.1", Textures.MSI_LOC
                + "runeArmor1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor.2", Textures.MSI_LOC
                + "runeArmor2.png", "#\n" + "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor.3", Textures.MSI_LOC
                + "runeArmor3.png", " # \n" + "#X#\n" + "##");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor.4", Textures.MSI_LOC
                + "runeArmor4.png", "###\n" + " X \n" + "###\n" + " # ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor.5", Textures.MSI_LOC
                + "runeArmor5.png", "###\n" + " # \n" + "#X#\n" + " # \n" + "###");
        
        // Armor_Head
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_head.1", Textures.MSI_LOC
                + "runeArmorHead1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_head.2", Textures.MSI_LOC
                + "runeArmorHead2.png", "#\n" + "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_head.3", Textures.MSI_LOC
                + "runeArmorHead3.png", " # \n" + "#X#\n" + "##");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_head.4", Textures.MSI_LOC
                + "runeArmorHead4.png", "###\n" + " X \n" + "###\n" + " # ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_head.5", Textures.MSI_LOC
                + "runeArmorHead5.png", "###\n" + " # \n" + "#X#\n" + " # \n" + "###");
        
        // Armor_Torso
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_torso.1", Textures.MSI_LOC
                + "runeArmorTorso1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_torso.2", Textures.MSI_LOC
                + "runeArmorTorso2.png", "#\n" + "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_torso.3", Textures.MSI_LOC
                + "runeArmorTorso3.png", " # \n" + "#X#\n" + "##");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_torso.4", Textures.MSI_LOC
                + "runeArmorTorso4.png", "###\n" + " X \n" + "###\n" + " # ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_torso.5", Textures.MSI_LOC
                + "runeArmorTorso5.png", "###\n" + " # \n" + "#X#\n" + " # \n" + "###");
        
        // Armor_Legs
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_legs.1", Textures.MSI_LOC
                + "runeArmorLegs1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_legs.2", Textures.MSI_LOC
                + "runeArmorLegs2.png", "#\n" + "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_legs.3", Textures.MSI_LOC
                + "runeArmorLegs3.png", " # \n" + "#X#\n" + "##");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_legs.4", Textures.MSI_LOC
                + "runeArmorLegs4.png", "###\n" + " X \n" + "###\n" + " # ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_legs.5", Textures.MSI_LOC
                + "runeArmorLegs5.png", "###\n" + " # \n" + "#X#\n" + " # \n" + "###");
        
        // Armor_Feet
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_feet.1", Textures.MSI_LOC
                + "runeArmorFeet1.png", "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_feet.2", Textures.MSI_LOC
                + "runeArmorFeet2.png", "#\n" + "X\n" + "#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_feet.3", Textures.MSI_LOC
                + "runeArmorFeet3.png", " # \n" + "#X#\n" + "##");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_feet.4", Textures.MSI_LOC
                + "runeArmorFeet4.png", "###\n" + " X \n" + "###\n" + " # ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.armor_feet.5", Textures.MSI_LOC
                + "runeArmorFeet5.png", "###\n" + " # \n" + "#X#\n" + " # \n" + "###");
        
        // Tool/Digger
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.digger.1", Textures.MSI_LOC
                + "runeTool1.png", "X#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.digger.2", Textures.MSI_LOC
                + "runeTool2.png", " #\n" + "#X");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.digger.3", Textures.MSI_LOC
                + "runeTool3.png", "#X#\n" + "# #");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.digger.4", Textures.MSI_LOC
                + "runeTool4.png", "###\n" + "#X#\n" + "###");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.digger.5", Textures.MSI_LOC
                + "runeTool5.png", " # \n" + "####\n" + "#X#\n" + "####\n");
        
        // Weapon
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.weapon.1", Textures.MSI_LOC
                + "runeWeapon1.png", "X#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.weapon.2", Textures.MSI_LOC
                + "runeWeapon2.png", "X#\n" + "# ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.weapon.3", Textures.MSI_LOC
                + "runeWeapon3.png", "#X##\n" + "   #");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.weapon.4", Textures.MSI_LOC
                + "runeWeapon4.png", "##  \n" + " #X#\n" + " ###");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.weapon.5", Textures.MSI_LOC
                + "runeWeapon5.png", "## # \n" + "##X##\n" + "# ###");
        
        // Bow
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.bow.1", Textures.MSI_LOC
                + "runeBow1.png", "X#");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.bow.2", Textures.MSI_LOC
                + "runeBow2.png", "X#\n" + "# ");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.bow.3", Textures.MSI_LOC
                + "runeBow3.png", "#X##\n" + "   #");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.bow.4", Textures.MSI_LOC
                + "runeBow4.png", "##  \n" + " #X#\n" + " ###");
        MultiSlotItemRegistry.registerUnlocalizedName("enchantment.bow.5", Textures.MSI_LOC
                + "runeBow5.png", "## # \n" + "##X##\n" + "# ###");
    }
    ...
    public static List<EnchantmentData> getEnchantments(ItemStack itemStack) {
        ...
        if (itemStack.itemID == Item.enchantedBook.itemID) {
            NBTTagList tagList = ((ItemEnchantedBook) itemStack.getItem()).func_92110_g(itemStack);
            if (tagList != null) {
                for (int i = 0; i < tagList.tagCount(); i++) {
                    NBTTagCompound tag = (NBTTagCompound) tagList.tagAt(i);
                    list.add(new EnchantmentData(tag.getShort("id"), tag.getShort("lvl")));
                }
            }
    ...
    public static void setEnchantments(ItemStack itemStack, List<EnchantmentData> list) {
