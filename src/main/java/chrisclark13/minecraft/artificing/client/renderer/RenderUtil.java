...
public class RenderUtil {
	...
	public static void render3DItemStackForDisplay(ItemStack itemStack) {
		...
		if (customRenderer != null) {
			...
			int passes = 1;
			boolean requiresPasses = itemStack.getItem()
					.requiresMultipleRenderPasses();

			if (requiresPasses) {
				passes = itemStack.getItem().getRenderPasses(
			...
			for (int pass = 0; pass < passes; pass++) {
				...
				int color = itemStack.getItem().getColorFromItemStack(
						itemStack, pass);
...
//				float vMax = icon.getMaxV();
				...
				if (itemStack != null && itemStack.hasEffect(pass)) {
					...
					render3DImage(tessellator, 0.0F, 0.0F, 1.0F, 1.0F, 256,
							256, 0.0625F);
					GL11.glPopMatrix();
					GL11.glPushMatrix();
					GL11.glScalef(f8, f8, f8);
	 ...
	 * positive Z axis.
	 */
	public static void render3DImage(Tessellator tessellator, float par1, float par2, float par3, float par4, int par5, int par6, float par7)
    {
        ...
        for (k = 0; k < par5; ++k)
        {
            ...
            tessellator.addVertexWithUV((double)f7, 0.0D, (double)(0.0F - par7), (double)f8, (double)par4);
            tessellator.addVertexWithUV((double)f7, 0.0D, 0.0D, (double)f8, (double)par4);
            tessellator.addVertexWithUV((double)f7, 1.0D, 0.0D, (double)f8, (double)par2);
            tessellator.addVertexWithUV((double)f7, 1.0D, (double)(0.0F - par7), (double)f8, (double)par2);
        }
        ...
        for (k = 0; k < par5; ++k)
        {
            ...
            tessellator.addVertexWithUV((double)f9, 1.0D, (double)(0.0F - par7), (double)f8, (double)par2);
            tessellator.addVertexWithUV((double)f9, 1.0D, 0.0D, (double)f8, (double)par2);
            tessellator.addVertexWithUV((double)f9, 0.0D, 0.0D, (double)f8, (double)par4);
            tessellator.addVertexWithUV((double)f9, 0.0D, (double)(0.0F - par7), (double)f8, (double)par4);
        }
        ...
        for (k = 0; k < par6; ++k)
        {
            ...
            tessellator.addVertexWithUV(0.0D, (double)f9, 0.0D, (double)par1, (double)f8);
            tessellator.addVertexWithUV(1.0D, (double)f9, 0.0D, (double)par3, (double)f8);
            tessellator.addVertexWithUV(1.0D, (double)f9, (double)(0.0F - par7), (double)par3, (double)f8);
            tessellator.addVertexWithUV(0.0D, (double)f9, (double)(0.0F - par7), (double)par1, (double)f8);
        }
        ...
        for (k = 0; k < par6; ++k)
        {
            f7 = (float)k / (float)par6;
            f8 = par4 + (par2 - par4) * f7 - f6;
            tessellator.addVertexWithUV(1.0D, (double)f7, 0.0D, (double)par3, (double)f8);
            tessellator.addVertexWithUV(0.0D, (double)f7, 0.0D, (double)par1, (double)f8);
            tessellator.addVertexWithUV(0.0D, (double)f7, (double)(0.0F - par7), (double)par1, (double)f8);
            tessellator.addVertexWithUV(1.0D, (double)f7, (double)(0.0F - par7), (double)par3, (double)f8);
        }

        tessellator.draw();
    }

	public static void renderCustomEquipped(IItemRenderer customRenderer,
			EntityLivingBase entity, ItemStack item) {
		if (customRenderer
				.shouldUseRenderHelper(EQUIPPED, item, EQUIPPED_BLOCK)) {
			GL11.glPushMatrix();
			GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
			customRenderer.renderItem(EQUIPPED, item, renderBlocksInstance,
					entity);
			GL11.glPopMatrix();
		} else {
			GL11.glPushMatrix();
	...
	public static void drawImagePart(float x, float y, float width,
			float height, int u, int v, int uWidth, int vHeight,
		...
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x, y + height, 0, (u + 0) * uScale, (v + 0)
				* vScale);
		tessellator.addVertexWithUV(x, y, 0, (u + 0) * uScale, (v + vHeight)
				* vScale);
		tessellator.addVertexWithUV(x + width, y + 0, 0, (u + uWidth) * uScale,
				(v + vHeight) * vScale);
		tessellator.addVertexWithUV(x + width, y + height, 0, (u + uWidth)
				* uScale, (v + 0) * vScale);
		tessellator.draw();
